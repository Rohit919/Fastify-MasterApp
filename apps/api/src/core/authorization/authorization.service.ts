...
import { isPermissionKey, SystemRoles, type PermissionKey } from '@app/api-contracts';
...
export class AuthorizationService {
   ...
   */
  async getContextForRequest(request: FastifyRequest): Promise<AuthorizationContext> {

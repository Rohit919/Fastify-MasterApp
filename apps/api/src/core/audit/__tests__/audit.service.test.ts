...
describe('AuditService.record', () => {
  ...
  it('uses the provided transaction client when given', async () => {
    ...
    const prisma = { auditLog: { create: baseCreate } } as unknown as PrismaClient;
    const tx = { auditLog: { create: txCreate } } as unknown as import('@prisma/client').Prisma.TransactionClient;

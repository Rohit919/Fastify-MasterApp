...
export const USER_CONTRACTS = {
  LIST: {
    ...
    errors: [ErrorCode.UNAUTHORIZED, ErrorCode.FORBIDDEN, ErrorCode.VALIDATION_ERROR],
    operationId: 'users.list',
    summary: 'List users (paginated)',
    description: 'Server-side pagination (default 25, max 100), search, role filter, whitelisted sort.',
    tags: ['Users'],
  },

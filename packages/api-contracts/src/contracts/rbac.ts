...
import { ROLE_ENDPOINTS, PERMISSION_ENDPOINTS, USER_ROLE_ENDPOINTS } from '../endpoints/admin.js';
...
export const ROLE_CONTRACTS = {
  ...
  CREATE: {
    ...
    errors: [ErrorCode.UNAUTHORIZED, ErrorCode.FORBIDDEN, ErrorCode.CONFLICT, ErrorCode.VALIDATION_ERROR],
  ...
  UPDATE: {
    ...
    body: UpdateRoleBody,
    response: { 200: RoleResponse },
    errors: [ErrorCode.UNAUTHORIZED, ErrorCode.FORBIDDEN, ErrorCode.NOT_FOUND, ErrorCode.VALIDATION_ERROR],
  ...
  DELETE: {
    ...
    errors: [ErrorCode.UNAUTHORIZED, ErrorCode.FORBIDDEN, ErrorCode.NOT_FOUND, ErrorCode.CONFLICT],
